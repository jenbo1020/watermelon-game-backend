...
import { ReqTaskUserReport, ResTaskUserReport } from "../../../shared/protocols/m/task/PtlTaskUserReport";
import { Global } from "../../../model/Global";
import { TaskUtil } from "./model/TaskUtil";
import { ETaskRefreshType } from "../../../shared/constant/task/TaskRefreshType";
import moment from "moment";

export default async function (call: ApiCall<ReqTaskUserReport, ResTaskUserReport>) {
    ...
    await Global.collection('TaskUserReport').insertOne(
        { activityId, taskId, uid: call.userInfo.uid, data, createTime: Date.now() }
    );
